...
![Java Installation](bin/images/JAVA.png)
...
![NeoForge Installer](bin/images/Neoforge.png)
...
1. **Launch Minecraft**  
   ...
   ![Minecraft Launcher](bin/images/Minecraft_launcher.png)

2. **Open the Installations menu** and follow the instructions:  
   ![Installations Menu](bin/images/Installation.png)
...
1. Go to **Multiplayer**
      ...
      ![alt text](bin/images/Multiplayer.png)

2. **Add Server**

      ![alt text](bin/images/AddServer.png)
